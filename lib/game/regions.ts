...
export const REGIONS: Region[] = [
  ...
  },
  {
    id: 'sunfire-desert',
    name: 'Sunfire Desert',
    description: 'A scorching wasteland of fire and ash.',
    requiredLevel: 15,
  ...
  },
  {
    id: 'neon-city',
    name: "Neon City",
    description: 'A cyberpunk metropolis ruled by machines.',
    requiredLevel: 20,
  ...
  },
  {
    id: 'storm-peaks',
    name: "Storm Peaks",
    description: 'The roaring heights where thunder lords dwell.',
    requiredLevel: 25,
    levels: createDragonsPeakLevels(), // Reusing for now
    unlocked: false,
    completed: false,
    environment: 'mountains',
    color: '#e91e63',
